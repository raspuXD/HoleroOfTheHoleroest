...
public class GamePause : MonoBehaviour
{
    ...
    [Header("Objects that prevent pausing")]
    public GameObject[] blockPauseObjects;
    ...
    public void TogglePause()
    {
        ...
        sceneHandler.UpdateMouseState(isPaused);
    ...
    {
        foreach (GameObject obj in blockPauseObjects)
        {
            if (obj.activeSelf)
            {
                return false;
